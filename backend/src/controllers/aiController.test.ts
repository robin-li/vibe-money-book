...
const MOCK_USER = {
  ...
  updatedAt: new Date(),
  categoryBudgets: [
    { id: 'cb-1', userId: MOCK_USER_ID, category: 'entertainment', type: 'expense', budgetLimit: 3000, isCustom: false, createdAt: new Date(), updatedAt: new Date() },
    { id: 'cb-2', userId: MOCK_USER_ID, category: 'food', type: 'expense', budgetLimit: 8000, isCustom: false, createdAt: new Date(), updatedAt: new Date() },
    { id: 'cb-3', userId: MOCK_USER_ID, category: 'daily', type: 'expense', budgetLimit: 2000, isCustom: false, createdAt: new Date(), updatedAt: new Date() },
    { id: 'cb-4', userId: MOCK_USER_ID, category: 'education', type: 'expense', budgetLimit: 2000, isCustom: false, createdAt: new Date(), updatedAt: new Date() },
    { id: 'cb-5', userId: MOCK_USER_ID, category: 'medical', type: 'expense', budgetLimit: 2000, isCustom: false, createdAt: new Date(), updatedAt: new Date() },
    { id: 'cb-6', userId: MOCK_USER_ID, category: 'transport', type: 'expense', budgetLimit: 3000, isCustom: false, createdAt: new Date(), updatedAt: new Date() },
    { id: 'cb-7', userId: MOCK_USER_ID, category: 'other', type: 'expense', budgetLimit: 0, isCustom: false, createdAt: new Date(), updatedAt: new Date() },
    { id: 'cb-8', userId: MOCK_USER_ID, category: 'salary', type: 'income', budgetLimit: 0, isCustom: false, createdAt: new Date(), updatedAt: new Date() },
    { id: 'cb-9', userId: MOCK_USER_ID, category: 'investment', type: 'income', budgetLimit: 0, isCustom: false, createdAt: new Date(), updatedAt: new Date() },
    { id: 'cb-10', userId: MOCK_USER_ID, category: 'pension', type: 'income', budgetLimit: 0, isCustom: false, createdAt: new Date(), updatedAt: new Date() },
    { id: 'cb-11', userId: MOCK_USER_ID, category: 'insurance', type: 'income', budgetLimit: 0, isCustom: false, createdAt: new Date(), updatedAt: new Date() },
    { id: 'cb-12', userId: MOCK_USER_ID, category: 'other_income', type: 'income', budgetLimit: 0, isCustom: false, createdAt: new Date(), updatedAt: new Date() },
  ],
};
