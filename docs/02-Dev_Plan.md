...
> **版本**：v1.6 (Vibe-Coding / 基於 AI Agentic 架構)
> **開發周期**：1-2 周
...
- [x] T-701 (A-Backend) 多供應商 LLM 引擎擴展
- [x] T-702 (A-Backend) AI 供應商與模型 API
- [x] T-703 (A-Frontend) 統計頁條狀圖交互展開
- [x] T-704 (A-Frontend) 設定頁 AI 引擎進階設定 UI
- [x] T-705 (A-QA) M7 E2E 測試更新
...
- [x] Issue #188 — 切換模型時區分 Key/Model 錯誤訊息 — PR merged 2026-03-26
