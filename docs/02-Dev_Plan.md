...
> **版本**：v1.8 (Vibe-Coding / 基於 AI Agentic 架構)
> **開發周期**：1-2 周
...
| v1.8 | 2026-04-09 | 規格文件改名對齊新版 vibe-sdlc-spec：API Spec 由 `01-3-API_Spec.md` 改為 `01-5-API_Spec.md`、UI/UX 設計由 `01-4-UI_UX_Design.md` 改為 `01-6-UI_UX_Design.md`，更新角色定義表與 T-001/T-101/T-201/T-202/T-301/T-302/T-401/T-501 等任務輸入引用 |
